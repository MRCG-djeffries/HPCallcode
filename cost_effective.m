...
n0=17600;%xvalout(1); % 17600
n1=6600;%xvalout(2);  %6600
y1=74;  % was 74
death_val=0.5;%xvalout_death(1);
...
[t1,x1t] = ode15s(@odeeq_v5T_2p_scaled_death,0:81,N0,[],M,Mdash,mort_current,mort_former,extra_parms_vals,phiminusvals, phiplussvals,age_matrix,...
...
for i = 1 : length(t1)
    ...
    N=XT(:,i);
    [~,~,moved_to_T4_former(:,i),moved_to_T4_current(:,i),total_not_T4(:,i),total_T4(:,i)]=treat_comps_pv3_scaled(n0,n1,y1,N,age_scale00,age_scale10,t1(i),pcom,alpha,time2015_inODEunits,age_weights',age_weights_former');
end
