function [phi,phidash,moved_to_T4_former,moved_to_T4_current,total_not_T4,total_T4]=treat_comps_pv3_scaled(n0,n1,y1,X,age_scale00,age_scale10,t,pcom,alpha,time2015_inODEunits,pwid_weights,former_weights)
...
if t>=time2015_inODEunits
    ...
    ndash=n-scale_sumphi_p_scaled(phi,age_scale00,age_scale10,jAdformer,jAdpwider,jMipwider,pwid_weights,former_weights);
